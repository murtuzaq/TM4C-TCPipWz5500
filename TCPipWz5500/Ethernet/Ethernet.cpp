...
{
  uint8_t tempMAC[6] ={0,0,0,0,0,0};
  W5100.init();
  //W5100.setMACAddress(mac); /*DELETED TO GET WIZ5500 unique MAC address*

  //do a software reset of controller;
  W5100.writeMR(0x80);
