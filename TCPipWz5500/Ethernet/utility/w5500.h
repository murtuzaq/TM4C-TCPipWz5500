...
private:
  ...
  inline static void initSS()    {IINCHIP_CS_Init();};//{ DDRB  |=  _BV(2); };
  inline static void setSS()     {IINCHIP_CSoff(); };  //{ PORTB &= ~_BV(2); };
  inline static void resetSS()   {IINCHIP_CSon(); };   //{ PORTB |=  _BV(2); };
